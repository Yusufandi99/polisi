<header>
    ...
    <div class="icons">
        ...
        <div class="dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="bellDropdown" id="notificationDropdown">
                <p class="dropdown-header text-center" style="font-size: 1.2rem;">Notifikasi</p>
                <div id="notificationContent" class="small" style="font-size: 1rem;"></div>
            </div>
        </div>
